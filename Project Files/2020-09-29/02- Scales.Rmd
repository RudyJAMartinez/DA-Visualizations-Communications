...
In the above graph, the legends don't show the black dots and therefore there is a mismatch between the points in the graph and the legend. You can switch on show.legend option in the first geom_point layer
...
Alternate Way of Creating Chart
